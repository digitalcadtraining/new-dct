          ...
          <div className="hero-flex" style={{display:"flex",gap:36,alignItems:"flex-start"}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              ...
              <p style={{fontSize:"clamp(13px,1.1vw,15px)",color:"rgba(255,255,255,0.72)",lineHeight:1.7,maxWidth:560,marginBottom:20}}>
                Learn from industry experts with {course.tutor.exp.toLowerCase()}. Real projects, live sessions, and guaranteed placement support across India.
              </p>
              ...
              <div style={{display:"flex",flexWrap:"wrap",gap:8,marginBottom:22}}>
                {[["🕐 "+course.duration,"Duration"],["📹 "+course.sessions+" Sessions","Live+Recorded"],["🏭 "+course.projects+" Projects","Industry Level"],["📜 Certificate","Govt. Recognised"],["💼 Placement","100% Support"]].map(([v,s])=>(
        ...
        <div className="section-pad" style={{maxWidth:1200,margin:"0 auto",padding:"0 24px"}}>
          <div style={{textAlign:"center",marginBottom:32}}>
            ...
            <div style={{display:"flex",justifyContent:"center",gap:28,flexWrap:"wrap"}}>
              {[[course.sessions+"+","Sessions"],[String(course.syllabus.length),"Phases"],[course.duration,"Duration"],[course.projects+"+","Projects"]].map(([v,l])=>(
      ...
      <section style={{background:C.lightBg,padding:"52px 0"}}>
        <div className="section-pad" style={{maxWidth:1200,margin:"0 auto",padding:"0 24px"}}>
          <div style={{textAlign:"center",marginBottom:28}}>
            <h2 style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:"clamp(24px,3vw,38px)",fontWeight:800,color:C.dark,marginBottom:8}}>{course.projects} Industry Projects You'll Build</h2>
